...
@section('content')
    ...
    <div class="container w-100">
        <div class="row gap-2 d-flex">
            <div class="col-md-3 bg-danger order-first height-75">
            </div>
            <div class="col-md-8">
                @foreach ($cars as $car)
                <div class="container">
                    <div class="row">
                      <div class="col-sm-12 mb-3">
                        <div class="card d-flex flex-row rounded-0">
                            <div class="card-image w-35">
                                <div id="car{{ $car->id }}" class="carousel slide carousel-fade">
                                    <div class="carousel-inner">
                                        @foreach ($car->images as $image)
                                        <div class="carousel-item active">
                                            <a href="#">
                                                <img src="{{ asset('storage/images/cars/' . $image->image) }}" class="d-block w-100" alt="Car Image">
                                            </a>
                                        </div>
                                        @endforeach
                                    </div>
                                    <button class="carousel-control-prev" type="button" data-bs-target="#car{{ $car->id }}" data-bs-slide="prev">
                                        <span class="carousel-control-prev-icon" aria-hidden="true"></span>
                                        <span class="visually-hidden">Previous</span>
                                    </button>
                                    <button class="carousel-control-next" type="button" data-bs-target="#car{{ $car->id }}" data-bs-slide="next">
                          ...
                          <div class="card-body">
                            <h5 class="card-title text-decoration-underline"><a href="#">{{ $car->manufacturers->brand ." ". $car->models->name ." ". $car->years->year }}</a></h5>
                            <p class="card-text">{{ $car->description ." ". $car->price }}</p>
                          </div>
                        </div>
                      </div>
                    </div>
          ...
          <div class="col-sm-12 mb-3">
            <div class="card d-flex flex-row">
                <div class="card-image w-25">
                    <img src="{{ asset('/storage/images/cars/car_image_64bafed00f4321.png') }}" class="card-img-top w-100" alt="Image 2">
                </div>
              <div class="card-body">
